            ...
            <form action="{{ route('activity.update', $activity['id']) }}" method="POST">
                ...
                <div class="row form-group">
                    <div class="col-lg-6 mb-4">
                        ...
                        <select name="technician_id" id="technician_id" class="form-control" required value="{{ $activity['technician_id'] }}">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <select name="type_id" id="type_id" class="form-control" required value="{{ $activity['type_id'] }}">
                            <option value="">Seleccione</option>
                        </select>
                    </div>
                </div>
