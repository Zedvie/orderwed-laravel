    ...
    <div class="row">
        <div class="col-lg-12 mb-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        Reporte de actividades por tecnico
                    </h6>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-lg-12 mb-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route("reports.export_orders_by_legalization_date") }}" method="POST">
                    @csrf
                    <div class="row form-group">
                        <div class="col-lg-6">
                            <label for="order_id">Hora inicial</label>
                        </div>
                            <div class="col-lg-5">
                        ...
                        <div class="col-lg-6">
                            <label for="order_id">Hora final</label>
                        </div>
                            <div class="col-lg-5">
                                <input type="date" class="form-control"
                                id="legalization_date" name="legalization_date" required >
